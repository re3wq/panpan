$(function(){
    //老师端--课后反馈表单隐藏
        $(".t_teacher_feedback").click(function(event) {
        ...
        $(".t_submit_tea").click(function(event) {
           ...
           // alert(arr_tea01.length)
           // alert(arr_tea03.length)
           // alert(arr_tea04.length)
           // alert(arr_tea05.length)
           // alert(arr_tea06.length)
           // alert(other_thing)
    ...
    $(".t_que_submit").click(function(event) {
        student_absence();
        $(".t_queqin_window").hide()
        // $(".t_tea_feedback_con").show()
    });
