$(function(){
        ...
        //综合评价
        //打开弹窗
        // $(".t_open_overall").click(function(event) {
             
        //     $(".t_overall_box").addClass('t_overall_box_show')
        //     $(".t_overall_box").animate({opacity:1},300);
        //     // $(".t_overall_content").removeClass('t_overall_content_show')
        //      //综合评价底部轮播
        //     mod_width=$(".t_module_four").width()
        //     banner_count=$(".t_mod_bannerout .t_mod_banner").length
        //     $(".t_mod_bannerout").width(banner_count*mod_width)
        //     move_count=0
        //     //添加圆点
        //     for(var i=0;i<banner_count;i++){
        //         $(".t_dotbox").append('<div class="t_dot" ></div>')
        //     }
        //     $(".t_dotbox").css("margin-left",-10*banner_count)
