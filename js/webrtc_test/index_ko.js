...
function onAudioTestDone(result) {
    ...
    if (result == 0) {
        ...
        titleText = text.MicTest + t_rtc11;
        ...
        titleText = text.MicTest + t_rtc12;
        $(".t_false1").hide()
        $(".t_false2").show()
        $(".t_false3").hide()
        $(".t_false4").hide()
...
function onVideoTestDone(result) {
    ...
    if (result == 0) {
        ...
        titleText = text.CameraTest + t_rtc11;
    } else {
        $("#camera-title2").css("background", "#ffe2db");
        $("#camera-title").css("color", "#ff5026");
        titleText = text.CameraTest + t_rtc12;
        $(".t_isvideo").show()
        // $(".t_false1").hide()
        // $(".t_false2").hide()
        // $(".t_false3").hide()
...
function onSupportTestDone(result) {
    ...
    if (result == 0) {
        ...
        titleText = text.SupportTest + t_rtc11;
    } else {
        $("#support-title2").css("background", "#ffe2db");
        $("#support-title").css("color", "#ff5026");
        titleText = text.SupportTest + t_rtc12;
        $(".t_isfen").show()
    }
...
function onConnectionTestDone(result) {
    ...
    if (result == 0) {
        ...
        titleText = text.ConnectionTest + t_rtc11;
    } else {
        $("#connection-title2").css("background", "#ffe2db");
        $("#connection-title").css("color", "#ff5026");
        titleText = text.ConnectionTest + t_rtc12;
    }
...
function startBrowserTest(){
    $("#browser-detail")[0].innerText = "";
    var titleText = null;
    $("#browser-title")[0].innerText = t_rtc13;
    $(".t_false1").show()
    $(".t_false2").hide()
