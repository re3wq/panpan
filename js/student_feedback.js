...
//学生端--课后反馈表单隐藏
$("body").on("click",".t_student_feedback",function(event) {
...
$("body").on("click",".t_stu_feedback_con",function(event) {
    event.stopPropagation();
});
//学生端--星星评价
$("body").on("click",".t_star_input",function(event) {
...
$("body").on("click",".t_submit",function(event) {
    arr.length=0;
    arr2.length=0;
    arr3.length=0;
...
$("body").on("click",".t_reset,.t_qqclose,.t_que_reset,.t_que_submit",function(event) {
